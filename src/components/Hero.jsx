...
function Hero() {
  return (
      <div>
          <div className='my-7 sm:my-0 max-w-[1200px] h-[80hv] mx-auto flex flex-col-reverse sm:flex-row justify-center align-center'>
              
            <div className= 'flex-col my-auto mx-auto'>
                <p className='md:text-5xl sm:text-4xl text-xl font-bold text-gray-200'>Hi I'm Priyank</p>
                <h1 className='md:text-7x1 sm:text-6xl text-4x1 font-bold md:py-6'>
                <TypeAnimation
                    sequence={[
                        "FullStack Developer",
                        1000,
                ...
                <div className='flex justify-center items-center'>
                    <p className='md:text-5xl sm: text-xl font-bold text-gray-500'>with a 1+ years experience</p>
                  </div>
